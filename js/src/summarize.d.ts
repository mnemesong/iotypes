...
export declare function summarizeIOArray<T extends {}, K extends (keyof T & string), N extends string>(arr: T[], dsl: SummarizeReq<T, K, N>): Record<N, SummarizeValsResult<typeof dsl[N][0]>>;
